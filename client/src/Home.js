function Home() {
    ...
    return (
     <div className="parent-container">
        ...
        <div>
            <img src="https://www.thelandingtahoe.com/content/uploads/2021/05/spa-towels-1920x1169.jpg"
        width="700px"
        height="400px"></img>
        </div>
        ...
        <div>
        <img src="https://elevationmedspa.com/wp-content/uploads/2018/08/Hero-22.jpg"
        width="700px"
        height="400px"></img>
        </div>
        <div className="blurb-container">
            ...
            <div>
                <img src="https://www.insidersguidetospas.com/wp-content/uploads/2018/01/Loma-de-Vida-Spa-Exterior-1.jpg"
                 width="700px"
                height="400px"></img>
            </div>
